...
setup(name='tumbo-server',
    ...
    license ='MIT',
    install_requires = reqs.append('django-sequence-field==master'),
    dependency_links = ['https://github.com/rpalacios/django-sequence-field.git#egg=django-sequence-field=master'],
