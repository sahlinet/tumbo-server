...
class KubernetesExecutor(BaseExecutor):
    ...
    def _start_command(self):
        start_command = "/home/tumbo/.virtualenvs/tumbo/bin/hupwatch -- %s %smanage.py start_worker --vhost=%s --base=%s --username=%s --password=%s" % (
                ...
                "template": {
                    ...
                    "spec": {
                        ...
                        "containers": [
                            {
                                "env": worker_env,
                                "image": "philipsahli/tumbo-worker:v0.5.37-dev",
