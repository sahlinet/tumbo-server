...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Process.rss'
        db.add_column(u'fastapp_process', 'rss',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Process.rss'
        db.delete_column(u'fastapp_process', 'rss')
    ...
    models = {
        ...
        u'fastapp.executor': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'default': "u'6zSLjYbmEk'", 'max_length': '20'}),
