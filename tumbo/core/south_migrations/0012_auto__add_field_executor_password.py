...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Executor.password'
        db.add_column(u'fastapp_executor', 'password',
                      self.gf('django.db.models.fields.CharField')(default=lambda: User.objects.make_random_password(), max_length=20),
                      keep_default=False)
	for executor in orm.executor.objects.all():
		executor.password=User.objects.make_random_password()
		executor.save()


    def backwards(self, orm):
        # Deleting field 'Executor.password'
        db.delete_column(u'fastapp_executor', 'password')
    ...
    models = {
        ...
        u'fastapp.executor': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'default': "u'y4cyEEvr7g'", 'max_length': '20'}),
