...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'fastapp_heartbeat')

        # Adding model 'Process'
        db.create_table(u'fastapp_process', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('running', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'fastapp', ['Process'])

        # Deleting field 'Thread.heartbeat'
        db.delete_column(u'fastapp_thread', 'heartbeat_id')

        # Adding field 'Thread.parent'
        db.add_column(u'fastapp_thread', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='threads', null=True, to=orm['fastapp.Process']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'Heartbeat'
        db.create_table(u'fastapp_heartbeat', (
            ('running', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'fastapp', ['Heartbeat'])

        # Deleting model 'Process'
        db.delete_table(u'fastapp_process')

        # Adding field 'Thread.heartbeat'
        db.add_column(u'fastapp_thread', 'heartbeat',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='threads', null=True, to=orm['fastapp.Heartbeat'], blank=True),
                      keep_default=False)

        # Deleting field 'Thread.parent'
        db.delete_column(u'fastapp_thread', 'parent_id')
    ...
    models = {
        ...
        u'fastapp.executor': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'default': "u'xk6AJkBfD8'", 'max_length': '20'}),
