...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fastapp_logentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('transaction', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['fastapp.Transaction'])),
        ...
        db.send_create_signal(u'fastapp', ['LogEntry'])


    def backwards(self, orm):
        # Deleting model 'LogEntry'
        db.delete_table(u'fastapp_logentry')
    ...
    models = {
        ...
        u'fastapp.executor': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'default': "u'DruDjxtrEG'", 'max_length': '20'}),
        ...
        u'fastapp.transaction': {
            ...
            'rid': ('django.db.models.fields.IntegerField', [], {'default': '75867743', 'primary_key': 'True'}),
