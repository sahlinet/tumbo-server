...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fastapp_heartbeat', (
            ...
            ('running', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'fastapp.executor': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'default': "u'NAT93CnD3Q'", 'max_length': '20'}),
            'pid': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'})
        },
        u'fastapp.heartbeat': {
            'Meta': {'object_name': 'Heartbeat'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'running': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        u'fastapp.host': {
