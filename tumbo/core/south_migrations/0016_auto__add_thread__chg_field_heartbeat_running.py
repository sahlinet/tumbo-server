...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Thread'
        db.create_table(u'fastapp_thread', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
            ('heartbeat', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='threads', null=True, to=orm['fastapp.Heartbeat'])),
            ('health', self.gf('django.db.models.fields.CharField')(default='SO', max_length=2)),
        ))
        db.send_create_signal(u'fastapp', ['Thread'])


        # Changing field 'Heartbeat.running'
        db.alter_column(u'fastapp_heartbeat', 'running', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting model 'Thread'
        db.delete_table(u'fastapp_thread')


        # Changing field 'Heartbeat.running'
        db.alter_column(u'fastapp_heartbeat', 'running', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'fastapp.executor': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'default': "u'JwSnpNq9sV'", 'max_length': '20'}),
        ...
        u'fastapp.thread': {
            ...
            'heartbeat': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'threads'", 'null': 'True', 'to': u"orm['fastapp.Heartbeat']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
