...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Setting.public'
        db.add_column(u'fastapp_setting', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Setting.public'
        db.delete_column(u'fastapp_setting', 'public')
    ...
    models = {
        ...
        u'fastapp.executor': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'default': "u'ZQqqS2FA6t'", 'max_length': '20'}),
        ...
        u'fastapp.transaction': {
            ...
            'rid': ('django.db.models.fields.IntegerField', [], {'default': '22138836', 'primary_key': 'True'}),
