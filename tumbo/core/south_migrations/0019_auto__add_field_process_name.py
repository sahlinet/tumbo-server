...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Process.name'
        db.add_column(u'fastapp_process', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Process.name'
        db.delete_column(u'fastapp_process', 'name')
    ...
    models = {
        ...
        u'fastapp.executor': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'default': "u'B3TWUkuwt9'", 'max_length': '20'}),
