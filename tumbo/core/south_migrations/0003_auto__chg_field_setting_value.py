...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fastapp_setting', 'value', self.gf('django.db.models.fields.CharField')(max_length=8192))

    def backwards(self, orm):

        # Changing field 'Setting.value'
        db.alter_column(u'fastapp_setting', 'value', self.gf('django.db.models.fields.CharField')(max_length=4096))
