...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fastapp_counter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('apy', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['fastapp.Apy'], unique=True)),
            ('executed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('failed', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'fastapp', ['Counter'])
        for apy in orm.Apy.objects.all():
            counter = orm.Counter(apy=apy)
            counter.save()

    def backwards(self, orm):
        # Deleting model 'Counter'
        db.delete_table(u'fastapp_counter')
    ...
    models = {
        ...
        u'fastapp.counter': {
            ...
            'apy': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['fastapp.Apy']", 'unique': 'True'}),
