...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Thread.name'
        db.alter_column(u'fastapp_thread', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Thread.name'
        db.alter_column(u'fastapp_thread', 'name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    models = {
        ...
        u'fastapp.executor': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'default': "u'Se32XSB854'", 'max_length': '20'}),
