...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fastapp_setting', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('base', self.gf('django.db.models.fields.related.ForeignKey')(related_name='setting', to=orm['fastapp.Base'])),
        ...
        db.send_create_signal(u'fastapp', ['Setting'])


    def backwards(self, orm):
        # Deleting model 'Setting'
        db.delete_table(u'fastapp_setting')
