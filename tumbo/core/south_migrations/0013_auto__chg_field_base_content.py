...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Base.content'
        db.alter_column(u'fastapp_base', 'content', self.gf('django.db.models.fields.CharField')(max_length=16384))

    def backwards(self, orm):

        # Changing field 'Base.content'
        db.alter_column(u'fastapp_base', 'content', self.gf('django.db.models.fields.CharField')(max_length=8192))
    ...
    models = {
        ...
        u'fastapp.executor': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'default': "u'fQtkBMzkSM'", 'max_length': '20'}),
